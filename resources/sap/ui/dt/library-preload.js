...
b.prototype.buildMoveEvent=function(){var m=this.getMovedOverlay();var o=m.getElementInstance();var s=this._getSource();var p=s.publicParent;var S=a.getOverlay(p);var t=O.getParentInformation(m);var i=s.index;var T=t.index;delete s.index;delete t.index;var c=this.getCommandFactory().getCommandFor(p,"Move",{movedElements:[{element:o,sourceIndex:i,targetIndex:T}],source:s,target:t},S.getDesignTimeMetadata());if(c){if(c.getMetadata().getName()==="sap.ui.dt.command.SimpleFormMove"){c.execute();}}else{jQuery.sap.log.error("Invalid move action in design time metadata of "+s.parent.getMetadata().getName());}return c;};
...
var a=M.extend("sap.ui.dt.DesignTimeMetadata",{metadata:{library:"sap.ui.dt",properties:{data:{type:"object"}}}});
...
a.prototype.getAssociatedDomRef=function(A,e){var o=E.getDomRef(e);var v=this.getAction(A,e).domRef;if(o){if(typeof v==="string"){return D.getDomRefForCSSSelector(o,v).get(0);}else if(typeof v==="function"){return v.call(this,e);}}else{if(typeof v==="function"){return v.call(this,e);}}};
...
E.prototype.createAggregationDesignTimeMetadata=function(a){var d=this.getAggregation(a);return new A({data:d});};
